  ...
  <body>
    <% String userName=(String) session.getAttribute("name"); session.getMaxInactiveInterval(); if(userName==null){
      ...
      <div class="container-fluid p-0">
        <form action="search" method="post" class="row g-3 needs-validation" novalidate>
                  ...
                  <div class="card bg-dark text-white" style="border-radius: 1rem">
                    <div class="card-body p-5 text-center">
                      <div class="mb-md-5 mt-md-4 pb-5">
                        <h2 class="fw-bold mb-2 text-uppercase">Search Record</h2>
                        <br />
                        ...
                        <div class="form-outline form-white mb-4 position-relative">
                          ...
                          <input type="text" id="typePasswordX" name="lname" placeholder="Last Name"
                            class="form-control form-control-lg" required />
                          <div class="invalid-tooltip">
